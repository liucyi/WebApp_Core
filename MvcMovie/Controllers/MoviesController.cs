...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Index(int page,string movieGenre, string searchString)
        {
            ...
            var pageOption = new PagerOption
            {
                ...
                RouteUrl = "/Movies/Index"
            };
            //分页参数
            ViewBag.PagerOption = pageOption;

            //数据
            return View(await movies.OrderByDescending(b => b.ID)
                .Skip((pageOption.CurrentPage - 1) * pageOption.PageSize)
                .Take(pageOption.PageSize).ToListAsync());
